...
def makeGT(id,counter):
    ...
    context = tfgnn.Context.from_fields(
        features={"injection_zenith":[fzenith],"event_energy":[fenergy],"injection_azimuth":[fazimuth],"event_id":[feventid],"hit_num":[fhitnum]})
...
##############################
counter =0
#with tf.io.TFRecordWriter('/n/holyscratch01/arguelles_delgado_lab/Everyone/tzhu/hex_SAM_4nnIDmetrics_1_70') as writer:
with tf.io.TFRecordWriter('/n/holyscratch01/arguelles_delgado_lab/Everyone/tzhu/ortho2SAM_4nnIDmetrics_1_70') as writer:
    for x in range(1,71):
